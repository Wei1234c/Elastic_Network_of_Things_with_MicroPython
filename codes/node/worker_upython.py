...
class Worker(Worker): 
    ...
    def read_GPIOs(self): 
        return read_GPIOs_pins() if IS_MICROPYTHON else "(Pin 16: 1, Pin 5: 0, Pin 13: 1, Pin 12: 1, Pin 14: 1, Pin 15: 0)"


    def write_GPIOs(self, pins_and_values = None): 
        return write_GPIOs_pins(pins_and_values) if IS_MICROPYTHON else "(Pin 16: 1, Pin 5: 0, Pin 13: 1, Pin 12: 1, Pin 14: 1, Pin 15: 0)"
